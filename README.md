...
- Project System Architecture, Person-Hour Estimates, Sprint Tickets, and Scrum Board: Contains our diagrams of our code flow, person-hour logs, explanation of our code, and what we did for each sprint.
- Meeting Logs
- Sprint Boards + Tickets

# Project Deliverables (Code):
- All front-end and back-end code is housed in this repository, including our model.
